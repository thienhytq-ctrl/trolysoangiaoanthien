...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Thiện - Trường  Tiểu học Thành Long Bản Ngò - ĐT: 097 1986 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Thiện - Trường Tiểu học Thành Long - ĐT: 097 2762869</div>", unsafe_allow_html=True)
